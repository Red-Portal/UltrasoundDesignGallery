...
\newcommand{\usdg}{Ultrasound Design Gallery}
\newcommand{\user}{user}
\newcommand{\User}{User}
...
\author{Kyurae Kim,~\IEEEmembership{Student Member,~IEEE,}
        Miran Lee,%~\IEEEmembership{Fellow,~OSA,}
        Kunkyu Lee,%~\IEEEmembership{Fellow,~OSA,}
        Min Kim,%~\IEEEmembership{Fellow,~OSA,}
        Tai-kyong Song,%~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
...
\begin{IEEEkeywords}
  Medical Ultrasound Imaging, Speckle Reduction, Bayesian Optimization, Design Gallery
\end{IEEEkeywords}}
...
The authors are also ever so greatful to Jungkyu Kang and Yangmo Yoo for their invaluable feedback on our image enhancement algorithm, Petrus Mikkola for discussions about the projective preferential Bayesian optimization algorithm, and Aki Vehtari for discussions about Gaussian processes.
